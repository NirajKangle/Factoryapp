...
export function MobileMenu({ open, children, className, ...props }: MobileMenuProps) {
...
function ListItem({
  ...
  return (
    <NavigationMenuLink
      className={cn(
        "flex w-full flex-row gap-x-2 rounded-sm p-2 hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground data-[active=true]:bg-accent/50 data-[active=true]:text-accent-foreground data-[active=true]:hover:bg-accent data-[active=true]:focus:bg-accent",
        className
      )}
      {...props}
      asChild
            ...
            <NavigationMenuList>
              <NavigationMenuItem>
                ...
                <NavigationMenuContent className="bg-background p-1 pr-1.5">
                  <ul className="grid w-[32rem] grid-cols-2 gap-2 rounded-md border bg-popover p-2 shadow">
